  ...
  return (
    <div>
      ...
      <Menu setGrid={setGrid} setGridComplete={setGridComplete} setTotalMoves={setTotalMoves}
        ...
        empty={empty} setEmpty={setEmpty} changeAppState={changeAppState}/>
      <div className={`leaderboard-wrapper ${leaderboardVisible ? "visible" : "hidden"}`}>
          <Leaderboard leaderboardMode={leaderboardMode} updateLeaderboardMode={updateLeaderboardMode}
          setLeaderboardVisible={setLeaderboardVisible} scores={scores} />
      </div>
